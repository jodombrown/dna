...
CREATE TABLE public.contact_requests (
  ...
  purpose TEXT NOT NULL CHECK (purpose IN ('connect', 'collaborate')),
  message TEXT,
...
CREATE INDEX idx_conversations_users ON public.conversations(user_1_id, user_2_id);
...
CREATE INDEX idx_contact_requests_sender ON public.contact_requests(sender_id);
