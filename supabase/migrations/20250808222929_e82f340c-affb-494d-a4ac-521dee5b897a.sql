-- Phase 1: Create/replace RPCs with proper privileges
-- 1) Dashboard counts
...
BEGIN
  ...
  -- Saved opportunities (best-effort, table may not exist)
  BEGIN
  ...
  -- Tasks due next 7 days (best-effort, table may not exist)
  BEGIN
  ...
  -- Unread notifications (matches existing schema: user_id, is_read)
...
-- 4) ADIN recommendations - Opportunities (derived from posts)
