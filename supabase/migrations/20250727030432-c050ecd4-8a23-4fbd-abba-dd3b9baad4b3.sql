-- Fix database performance warnings from linter
-- This migration addresses auth RLS initplan issues, duplicate policies, and duplicate indexes
...
-- 4. Fix duplicate indexes on post_reactions
-- Keep the more descriptive index name and drop the duplicate
DROP INDEX IF EXISTS public.unique_user_emoji_post;
-- Keep unique_user_post_emoji as it's more descriptive of the actual constraint