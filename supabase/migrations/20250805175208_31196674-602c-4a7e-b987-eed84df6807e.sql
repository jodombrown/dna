...
-- 1. Fix search_path for existing functions that need it
ALTER FUNCTION public.calculate_profile_completeness_score_new(uuid) SET search_path TO 'public';
ALTER FUNCTION public.update_profile_completeness_trigger_new() SET search_path TO 'public';

-- 2. Remove duplicate permissive policies and consolidate them
...
-- 3. Fix conversation policy with optimized auth calls
