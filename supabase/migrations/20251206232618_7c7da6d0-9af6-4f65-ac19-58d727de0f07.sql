-- Fix rpc_get_profile_bundle function - correct LIMIT placement in subqueries
...
BEGIN
  ...
  -- Get spaces (via collaboration_memberships) - fixed: LIMIT inside subquery
  ...
  -- Get events (via event_attendees) - fixed: LIMIT inside subquery
