...
-- Update the rpc_get_profile_bundle function to:
-- 1. Include is_public and allow_profile_sharing in the returned profile
-- 2. Return NULL for non-public profiles when viewer is not the owner
-- This enables unauthenticated public profile access at /u/:username
...
BEGIN
  ...
  v_result := json_build_object(
    'profile', json_build_object(
      ...
      -- Add is_public and allow_profile_sharing for visibility controls
      ...
      -- Add tag arrays directly on profile for convenience
