-- Retry: fix existence checks using pg_policies.policyname
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
      ...
      AND policyname = 'Users can create their own spaces'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
      AND tablename = 'collaboration_spaces' 
      AND policyname = 'Public can view public spaces or members can view'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
      AND tablename = 'collaboration_spaces' 
      AND policyname = 'Owners/admins can update spaces'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
      AND tablename = 'collaboration_spaces' 
      AND policyname = 'Owners/admins can delete spaces'
  ) THEN
