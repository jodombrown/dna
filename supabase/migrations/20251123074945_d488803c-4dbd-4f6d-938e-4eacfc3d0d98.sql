-- DNA | FEED INTERACTION FIXES v1
-- Enable full functionality for reactions, likes, and bookmarks

-- Fix 1: Update get_universal_feed to properly handle bookmarks tab and has_bookmarked
...
-- Fix 2: Ensure post_reactions table has proper user_id check in WITH CHECK
-- (This prevents RLS violations on insert)
...
-- Fix 3: Ensure post_bookmarks has proper WITH CHECK on insert
