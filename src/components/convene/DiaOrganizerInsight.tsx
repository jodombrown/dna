      ...
      <div className="relative flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 mb-1">
            <span className="text-micro font-bold uppercase tracking-wider text-dna-dia">
              DIA
            </span>
          </div>
          ...
          <Button
            size="sm"
            className="h-7 px-3 text-meta bg-dna-dia hover:bg-dna-dia/90 text-primary-foreground"
