...
import EnhancedCollaborationsMainContent from './EnhancedCollaborationsMainContent';
...
const EnhancedCollaborationsPageWrapper = () => {
  useScrollToTop();
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <EnhancedCollaborationsMainContent
        projects={projects}
        filters={filters}
...
export default EnhancedCollaborationsPageWrapper;
