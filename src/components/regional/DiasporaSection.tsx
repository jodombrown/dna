    ...
    <section className="py-16 px-4">
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Diaspora Impact</h2>
          ...
          {remittanceStats.map((stat, index) => (
            <Card key={index} className="text-center">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold mb-1">{stat.country}</h3>
                <p className="text-2xl font-bold text-primary mb-1">{stat.amount}</p>
        ...
        <Card className="bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10 border-none">
          <CardContent className="p-8 text-center">
            <h3 className="text-2xl font-bold mb-4">Join the Diaspora Network</h3>
