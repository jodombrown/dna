...
export function NeedEditor({ externalOpenSignal }: NeedEditorProps = {}) {
  ...
  return (
    <section className="space-y-4">
      ...
      {showSoftWarn && (
        <div className="text-meta text-dna-warning bg-dna-warning/10 border border-dna-warning/30 rounded-md px-3 py-2">
          You have {activeCount} of {NEED_ACTIVE_CAP} active Needs. Close ones that are no longer current to keep your signal sharp.
        </div>
      )}
      {atCap && (
        <div className="text-meta text-muted-foreground bg-muted border border-border rounded-md px-3 py-2">
