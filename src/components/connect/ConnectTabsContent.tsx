...
const ConnectTabsContent: React.FC<ConnectTabsContentProps> = ({
  ...
  const additionalProfessionals: Professional[] = [
    ...
    },
    {
      ...
      profession: 'Africa Tech Investment Director',
      company: 'Andreessen Horowitz',
      location: 'Silicon Valley, USA',
      country_of_origin: 'Ally - Chinese American',
      ...
      skills: ['Venture Capital', 'African Tech Ecosystem', 'Strategic Partnerships', 'Cross-border Investment'],
      avatar_url: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400',
      is_mentor: true,
      is_investor: true,
      looking_for_opportunities: false,
    ...
    {
      id: 'prof75',
      full_name: 'Aisha Omar-Jackson',
      profession: 'Renewable Energy Engineer',
      company: 'Tesla Energy',
      location: 'Austin, USA',
      country_of_origin: 'Mogadishu, Somalia / Atlanta, USA',
      bio: 'Somali-American engineer developing clean energy solutions for off-grid communities in Africa.',
      skills: ['Solar Engineering', 'Grid Infrastructure', 'Energy Storage', 'Rural Electrification'],
      avatar_url: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400',
      is_mentor: true,
      is_investor: false,
      looking_for_opportunities: true,
    ...
    },
    {
      ...
      profession: 'Afro-Latin Cultural Ambassador',
      company: 'OAS Cultural Programs',
      location: 'Bogotá, Colombia',
      country_of_origin: 'Afro-Colombian Heritage',
      bio: 'Celebrating and preserving Afro-Latin connections to Africa through cultural exchange programs.',
      skills: ['Cultural Diplomacy', 'Afro-Latin Studies', 'Community Organizing', 'International Relations'],
      avatar_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400',
      is_mentor: true,
      is_investor: false,
      looking_for_opportunities: false,
    ...
    {
      id: 'prof77',
      full_name: 'Dr. Thandiwe Nyong',
      profession: 'AI Ethics Researcher',
      company: 'Google DeepMind',
      location: 'London, UK',
      country_of_origin: 'Cape Town, South Africa',
      bio: 'Ensuring AI systems are fair and inclusive for African and global South communities.',
      skills: ['Artificial Intelligence', 'Ethics', 'Algorithmic Bias', 'Responsible AI'],
      avatar_url: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400',
      is_mentor: true,
      is_investor: false,
      looking_for_opportunities: false,
    ...
    },
    {
      ...
      profession: 'Sports Development Director',
      company: 'NBA Africa',
      location: 'Johannesburg, South Africa',
      country_of_origin: 'African American Heritage',
      bio: 'African American executive developing basketball talent across Africa and connecting youth with opportunities.',
      skills: ['Sports Management', 'Youth Development', 'International Relations', 'Talent Development'],
      avatar_url: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400',
      is_mentor: true,
      is_investor: true,
      looking_for_opportunities: false,
    ...
    },
    {
      ...
      profession: 'Tropical Medicine Specialist',
      company: 'Médecins Sans Frontières',
      location: 'São Paulo, Brazil',
      country_of_origin: 'Afro-Brazilian Heritage',
      bio: 'Afro-Brazilian physician working on health initiatives across Portuguese-speaking Africa.',
      skills: ['Tropical Medicine', 'Infectious Diseases', 'Global Health', 'Medical Research'],
      avatar_url: 'https://images.unsplash.com/photo-1594824389862-a8ec2d0f8c3d?w=400',
      is_mentor: true,
      is_investor: false,
      looking_for_opportunities: false,
    ...
    },
    {
      ...
      profession: 'Impact Storyteller & Documentarian',
      company: 'Independent',
      location: 'Toronto, Canada',
      country_of_origin: 'Ally - European Heritage',
      bio: 'Documentary filmmaker dedicated to amplifying African diaspora stories and social impact initiatives.',
      skills: ['Documentary Film', 'Social Impact', 'Visual Storytelling', 'Community Engagement'],
      avatar_url: 'https://images.unsplash.com/photo-1494790108755-2616b35d4e1c?w=400',
      is_mentor: true,
      is_investor: false,
      looking_for_opportunities: true,
    ...
    },
    {
      ...
      profession: 'Blockchain Infrastructure Lead',
      company: 'Polygon',
      ...
      skills: ['Blockchain', 'DeFi', 'Cryptocurrency', 'Financial Infrastructure'],
    ...
    {
      id: 'prof82',
      full_name: 'Michelle Pierre-Louis',
      profession: 'Climate Justice Advocate',
      company: 'Caribbean Climate Alliance',
      location: 'Miami, USA',
      country_of_origin: 'Haitian-American Heritage',
      bio: 'Haitian-American advocate connecting Caribbean and African communities on climate resilience strategies.',
      skills: ['Climate Advocacy', 'Environmental Justice', 'Policy Development', 'Community Mobilization'],
      avatar_url: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400',
      is_mentor: true,
      is_investor: false,
      looking_for_opportunities: false,
    ...
    {
      id: 'prof83',
      full_name: 'Dr. Ahmed Osman',
      profession: 'EdTech Innovation Director',
      company: 'UNICEF',
      location: 'Dubai, UAE',
      ...
      skills: ['Educational Technology', 'Digital Learning', 'Child Development', 'Innovation Management'],
      avatar_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400',
      is_mentor: true,
      is_investor: false,
      looking_for_opportunities: true,
    ...
    {
      id: 'prof84',
      full_name: 'Amina Johnson-Clarke',
      profession: 'Social Entrepreneurship Professor',
      ...
      skills: ['Social Innovation', 'Entrepreneurship', 'Academic Research', 'Mentorship'],
      avatar_url: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400',
      is_mentor: true,
      is_investor: true,
      looking_for_opportunities: false,
    ...
    {
      id: 'prof85',
      full_name: 'Jean-Baptiste Mokoko',
      profession: 'Circular Economy Consultant',
      company: 'Ellen MacArthur Foundation',
      location: 'Paris, France',
      country_of_origin: 'Brazzaville, Congo',
      bio: 'Congolese sustainability expert helping African businesses transition to circular economy models.',
      skills: ['Circular Economy', 'Sustainability Consulting', 'Resource Management', 'Business Transformation'],
      avatar_url: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400',
      is_mentor: true,
      is_investor: false,
      looking_for_opportunities: true,
