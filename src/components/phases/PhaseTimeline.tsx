  ...
  <section className="py-12 md:py-16 bg-white">
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-8 md:mb-12">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 md:mb-4">Phase Timeline</h2>
      ...
      <div className="space-y-6 md:space-y-8">
        {milestones.map((milestone, idx) => (
          <Card key={idx} className={`
            hover:shadow-xl transition-all hover:-translate-y-2 border-l-4 relative z-10
            ...
            <CardContent className="pt-4 md:pt-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 md:mb-6">
                <div>
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900">{milestone.title}</h3>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-3 md:gap-4">
                {milestone.items.map((item, i) => (
                  <div key={i} className="flex items-start gap-3 p-3 md:p-4 bg-white rounded-lg border hover:shadow-md transition-shadow">
                    <CheckCircle className={`w-4 h-4 md:w-5 md:h-5 ${milestone.status === "active" ? `text-${color}` : "text-gray-400"} flex-shrink-0 mt-0.5`}/>
