  ...
  const saveDraft = async () => {
    ...
    try {
      ...
      const eventPayload = {
        ...
        start_time: eventData.date_time || new Date().toISOString(),
        end_time: eventData.date_time || new Date().toISOString(),
        ...
        cover_image_url: eventData.banner_url || eventData.image_url,
        is_public: eventData.visibility !== 'draft',
