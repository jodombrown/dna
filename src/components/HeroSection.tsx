          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center min-h-[60vh] py-8 lg:py-12">
            ...
            <div className="space-y-4 lg:space-y-8">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-lg sm:text-xl lg:text-2xl xl:text-3xl text-muted-foreground mb-2 lg:mb-3 leading-relaxed text-left sm:text-center lg:text-left">
                ...
                {/* Legal Disclaimer */}
                <p className="text-xs sm:text-sm text-neutral-600 text-left sm:text-center lg:text-left leading-relaxed">
