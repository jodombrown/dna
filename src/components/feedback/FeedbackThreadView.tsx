...
export function FeedbackThreadView({
  ...
  return (
    <ResponsiveModal open={isOpen} onOpenChange={(open) => !open && onClose()} className="max-w-2xl max-h-[90vh] flex flex-col p-0">
      <ResponsiveModalHeader className="px-4 py-3 border-b shrink-0">
        <div className="flex items-center gap-3">
          ...
          <ResponsiveModalTitle>Thread</ResponsiveModalTitle>
        </div>
      </ResponsiveModalHeader>
