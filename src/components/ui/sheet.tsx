...
const sheetVariants = cva(
  "fixed z-[1000] gap-4 bg-background p-8 shadow-lg border-2 border-gray-200 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 overflow-hidden",
  {
    variants: {
      side: {
