    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Description */}
          <motion.p 
            className="font-outfit font-light text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed text-base md:text-lg"
            initial={{ opacity: 0, y: 30 }}
            animate={isVisible ? { opacity: 1, y: 0 } : {}}
          ...
          >
            <div className="bg-white/10 border border-white/20 rounded-xl px-6 py-4 backdrop-blur-sm">
              <p className="font-outfit text-white/60 text-xs uppercase tracking-wider mb-1">Mission</p>
              <p className="font-cormorant font-medium text-white text-lg">Mobilize the Global African Diaspora</p>
            </div>
            <div className="bg-white/10 border border-white/20 rounded-xl px-6 py-4 backdrop-blur-sm">
              <p className="font-outfit text-white/60 text-xs uppercase tracking-wider mb-1">Vision</p>
          ...
          {/* Footer */}
          <motion.p 
            className="font-outfit text-white/40 text-sm"
            initial={{ opacity: 0 }}
