  ...
  return (
    <div className="max-w-3xl mx-auto mb-3">
      <p className="text-lg md:text-xl mb-4 text-dna-forest leading-relaxed">
        ...
        , an ecosystem builder and entrepreneur committed to uniting visionary leaders, builders, and changemakers across the African diaspora. These are individuals driven by purpose, rich in talent, and ready to accelerate Africa's development.
      </p>
