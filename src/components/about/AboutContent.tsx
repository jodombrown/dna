...
/**
 * The About page body. Lives as a component (not under src/pages) so its
 * section rhythm and container widths are component layout, not page-level
 * values. The page shell (SEO, scroll, background) stays in src/pages/About.
 */
const AboutContent = () => {
    ...
    <>
      ...
      <section className="py-12 border-b border-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          />
          <h1 className="text-display sm:text-hero font-display text-foreground max-w-3xl mb-6 text-center sm:text-left">
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
            <h2 className="text-h1 font-display text-foreground text-center sm:text-left">Why DNA exists</h2>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-xl border border-border bg-card p-6">
              <h3 className="text-h2 font-display text-foreground mb-3">Our mission</h3>
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              <h3 className="text-h2 font-display text-foreground mb-3">Our vision</h3>
              <p className="text-body text-muted-foreground leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-display font-display text-foreground mb-1 text-center sm:text-left">Jaûne L. Odombrown</h2>
              ...
              <figure className="mt-8 border-l border-dna-copper pl-5">
                <blockquote className="text-h3 font-display italic text-foreground leading-relaxed max-w-prose">
      ...
      <section className="py-12 bg-muted/40 border-y border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-h1 font-display text-foreground mb-8 text-center sm:text-left">Our core values</h2>
          <ol className="grid md:grid-cols-3 gap-6">
            {CORE_VALUES.map(({ numeral, name, copy }) => (
              ...
              >
                ...
                <h3 className="text-h2 font-display text-foreground mt-2 mb-2">{name}</h3>
      ...
      <section className="py-12 border-t border-border">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-h1 font-display text-foreground mb-4 text-center sm:text-left">Join the mobilization</h2>
