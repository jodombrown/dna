    ...
    <ResponsiveModal open={isOpen} onOpenChange={onClose} className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <div className="space-y-3 pt-4 border-t border-border">
            <p className="text-body font-medium text-foreground">How should we notify you?</p>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              <input
                ...
                className="w-4 h-4 rounded border-border text-dna-emerald focus:ring-dna-emerald"
              />
              <span className="text-body text-muted-foreground">In-app notifications from DIA</span>
            </label>
          </div>
