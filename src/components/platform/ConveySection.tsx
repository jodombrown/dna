...
const ConveySection = () => {
  ...
  return (
    <section id="convey-section" className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-8 lg:gap-12 items-center">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Convey</h2>
            </div>
            <p className="text-lg sm:text-xl font-semibold text-gray-900 mb-2 sm:mb-3">
              Share Stories That Inspire the Movement
            </p>
            <p className="text-base sm:text-lg text-gray-600 mb-6 leading-relaxed">
              Amplify your impact by sharing your journey, insights, and wins. Inspire others with authentic diaspora voices and stay informed with curated news that matters to our community.
            </p>
