      ...
      <section id="dna-framework" className="py-16 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-h2 text-muted-foreground max-w-4xl mx-auto leading-relaxed mb-4 text-left sm:text-center">
            ...
            <p className="text-body text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-12 text-left sm:text-center">
