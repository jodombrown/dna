...
const AppDashboard = () => {
  ...
  try {
    console.log('AppDashboard: Getting layout store...');
    const { leftSidebarOpen, rightSidebarOpen, toggleLeftSidebar, toggleRightSidebar } = useLayoutStore();
    console.log('AppDashboard: Layout store loaded successfully');

    console.log('AppDashboard: Starting render...');
    return (
    ...
    console.error('AppDashboard error:', error);
