...
import { BarChart, Users, Settings, Shield, ArrowLeft, Activity, MessageCircle } from 'lucide-react';
        ...
        <div className="bg-card border-b border-border">
          <div className="max-w-7xl mx-auto px-4">
            <nav className="flex gap-2 py-3 overflow-x-auto">
              ...
              <NavLink to="/app/admin/health" className={navLinkClass}>
              ...
              <NavLink to="/app/admin/feedback" className={navLinkClass}>
