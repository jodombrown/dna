          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-2">
                <Newspaper className="h-6 w-6 sm:h-8 sm:w-8 text-dna-copper flex-shrink-0" />
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-serif truncate">DiasporaDaily</h1>
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground italic">Stories of Impact • Innovation • Transformation</p>
            </div>
