...
export const features: FeatureSummary[] = [
  ...
  {
    slug: "profile-and-identity",
    name: "Profile & Identity",
    pillar: "Connect",
    category: "Feature",
    status: "live",
    shortTagline: "Share your heritage, skills, story, and purpose.",
    oneLiner:
      "Profile & Identity lets you build trust and visibility, improve recommendations, and track your contributions and activity.",
    audience: ["Members", "Contributors", "Partners"],
    overviewOrder: 7,
  },
  {
    slug: "messaging",
    ...
    category: "Feature",
    status: "live",
    shortTagline: "Conversations that spark collaboration.",
    oneLiner:
      "Messaging enables 1:1 and group chats, safe and private conversations, and connections across regions.",
    audience: ["Members", "Collaborators"],
    overviewOrder: 8,
  },
  {
    ...
    category: "Feature",
    status: "live",
    shortTagline: "Explore the diaspora with intention.",
    oneLiner:
      "Search & Discovery helps you find members, spaces, events, and opportunities, filtered by skills, region, and topics.",
  ...
  },
  {
    ...
    category: "Feature",
    status: "live",
    shortTagline: "The home for communities, projects, teams, and initiatives.",
    oneLiner:
      "Spaces help you organize people across regions, host events, tasks, needs, and updates, and build real belonging.",
    audience: ["Members", "Project Leaders", "Community Organizers"],
    overviewOrder: 10,
  },
  {
    ...
    category: "Feature",
    status: "beta",
    shortTagline: "Turn ideas into organized execution.",
    oneLiner:
      "Tasks & Projects lets you create tasks, boards, and milestones, assign owners and track progress, and collaborate with clarity.",
    audience: ["Teams", "Project Leaders", "Contributors"],
    overviewOrder: 11,
  },
  {
    slug: "needs-and-offers",
    name: "Needs & Offers",
    pillar: "Contribute",
    category: "Feature",
    status: "beta",
    shortTagline: "Match people who need support with people who can help.",
    oneLiner:
      "Needs & Offers helps you post needs, make offers, validate contributions, and earn badges.",
    audience: ["Members", "Contributors", "Funders", "Organizations"],
    overviewOrder: 12,
  },
  {
    slug: "universal-composer",
